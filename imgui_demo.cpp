...
// - Use intrusively stored selection (e.g. 'bool IsSelected' inside your object), this is by far the simplest way
//   to store your selection data, but it means you cannot have multiple simultaneous views over your objects.
